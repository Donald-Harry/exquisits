<?php
// session_start();
include "../php/model/connection.php";
include "../php/controller/signinprocess.php";
$profusers = new Signinprocess($_SESSION['email'], '');
$profusers->setid();
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- Mirrored from chrev.dexignzone.com/xhtml/form-element.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Nov 2020 16:03:11 GMT -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="app-profile.html">Deposits</a></li>
                    ...
                    <li><a class=" ai-icon" href="app-profile.html" aria-expanded="false">
                            <i class="flaticon-381-internet"></i>
                            <span class="nav-text">Transactions History</span>
                        </a>
                    </li>
                    <li><a class=" ai-icon" href="app-profile.html" aria-expanded="false">
                            <i class="flaticon-381-internet"></i>
                    ...
                    <li><a class=" ai-icon" href="email-inbox.html" aria-expanded="false">
                            <i class="flaticon-381-internet"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method="post" action="../php/view/editprofile.php">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label">Fullname</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <button type="submit" class="btn btn-primary" name="update">Sign
                                                    in</button>
                                            </div>
                                        </div>
                                    </form>
