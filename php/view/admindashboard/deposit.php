                                    ...
                                    <div class="card-body">
                                        <div class="row m-3">
                                            <div class="col-sm-8 col-md-6 mb-4">
                                                <p class="fs-20 text-white">Copy Wallet Address</p>
                                        ...
                                        <div class="tab-pane fade active show" id="monthly">
                                            <div class=" d-flex">
                                                <div class="card-header border-0 d-block">
                                                    <div>
                                                        <h4 class="fs-20 text-white">Pending Deposits</h4>
                                                    </div>
                                                ...
                                                <div class="card-header border-0  d-block">
                                                    <div>
                                                        <h4 class="fs-20 text-white">Approved Deposits</h4>
                                                    </div>
                                                    <table class="table table-sm mb-0 table-striped">
                                                        <thead>
                                                            <tr>
