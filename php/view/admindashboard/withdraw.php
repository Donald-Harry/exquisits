...
include "../../view/admindashboard/includes/session.php";
include "../../view/admindashboard/includes/details.php";
$allusers = new Usercontroller();
$allwithdraw = new Withdrawcontroller();
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="">
                                    ...
                                    <div class="card-body p-2 tab-content card-table">
                                        <div class="tab-pane fade active show" id="monthly">
                                            <div class="table-responsive">
                                                <table class="table table-sm mb-0 table-striped">
                                                    ...
                                                    <tbody id="">
                                                        <?php $allwithdraw->userwithdrawal(); ?>
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
