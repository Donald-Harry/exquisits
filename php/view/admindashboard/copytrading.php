                            ...
                            <div class="col-xl-12">
                                <div class="">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <p class="fs-20 text-white">Trades</p>
                                            </div>
                                            <div class="col-12 col-md-6">
                                            <form method="post" class="form-group" id="copytrade" enctype="multipart/form-data">
                                                    <div class="p-1">
                                                        <input type="text" name="traderName"
                                                            class="form-control" placeholder="Traders Name">
                                                    </div>
                                                    <div class="p-1">
                                                        <input type="file" class="form-control" name="photo" id="">
                                                    </div>
                                                    <div class="p-1">
                                                        <input type="number" name="success" class="form-control"
                                                            placeholder="Trading success (%)">
                                                    </div>
                                                    <div class="p-1">
                                                    ...
                                                    <div class="p-1 d-flex flex-column">
                                                        <button class="btn rounded-0 btn-success" name="buy"
                                                            onclick="createtrader()" type="submit">Create</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-12">
