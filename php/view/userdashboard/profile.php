                            ...
                            <div class="col-xl-12">
                                <div class="">
                                    <div class="card-header d-block d-sm-flex border-0 pb-0">
                                        <div>
                                            <h4 class="fs-20 text-white">User Verification</h4>
                                    ...
                                    <div class="card-body ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 col-md-6 mb-4 pl-3">
                                                <p class="fs-20 text-white">Upload a valid means of Identification (Passport Data Page/ National ID)</p>
                                                

                                                <form method="post" class="form-group" action="../photo.php"
                                                    enctype="multipart/form-data">
                                                    <small class="form-text" style="color: red;">
                                                        <?php
														if (isset($_SESSION['errorphoto'])) {
															echo $_SESSION['errorphoto'];
															unset($_SESSION['errorphoto']);
														}
														?>
                                                    </small>
                                                    <div class="input-group my-2">
                                                        <input type="file" name="validid" class="form-control">
                                                    </div>
                                                    <div class="input-group input-group-lg">
                                                        
                                                        <a class="btn btn-outline-primary rounded-0 border mr-2" href="../approvephoto.php?user_id=<?=$user_id?>">Skip</a>
                                                ...
                                                <p class="form-text" style="color: green;">
                                                        <?php
														if (isset($_SESSION['successphoto'])) {
															echo $_SESSION['successphoto'];
														}
														?>
                                                    </p>
                                            </div>
