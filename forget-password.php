        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="signin">
                    ...
                    <!-- login form begin -->
                    <form class="uk-grid uk-form" method="post" action="php/view/forget-password.php">
                        ...
                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                            ...
                            <input class="uk-input uk-border-rounded" id="username" value="" name="email" type="email"
                                placeholder="Email">
                        </div>
