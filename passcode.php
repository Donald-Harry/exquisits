        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="signin">
                    ...
                    <p class="uk-text-small uk-margin-remove-top uk-margin-medium-bottom">Enter your email address</a>
                    </p>
                    <!-- login form begin -->
                    <form class="uk-grid uk-form" method="post" action="php/view/passcode.php">
                        ...
                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                            ...
                            <input class="uk-input uk-border-rounded" id="username" value="" name="passcode" type="text"
                                placeholder="Passcode">
                        </div>
                        <div class="uk-margin-small uk-width-1-1">
                            <button class="uk-button uk-width-1-1 uk-button-primary uk-border-rounded uk-float-left"
                                type="submit" name="submit">Confirm reset code</button>
                        </div>
                    </form>
                    <!-- login form end -->
