            ...
            <div class="col-12 col-md-4">
                <div class="signin">
                    ...
                    <p class="uk-text-small uk-margin-remove-top uk-margin-medium-bottom">Check the verification email
                        at <?php $email = $_GET['email']; echo $email  ?> and enter your verification code below.</p>
                    <div class="col-12 mb-3 col-md-6 offset-3">
                        <div class="bgl-info border border-info media align-items-center">
                            <div class="">
                                ...
                                ?>
                                <form action="php/view/verifymail.php" method="post">
                                    <?php $email = $_GET['email'] ?>
                                    <div>
                                        <input type="hidden" name="email" value="<?= $email ?>">
                                        <input type="text" name="code" placeholder="Verification code" class="form-control">
                                    </div>
                    ...
                    <ul>
                        ...
                        <li>If you have not received an email, we kindly request that you contact
                            support@equitifort.com for further assistance.</li>
                    </ul>
