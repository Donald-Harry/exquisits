...
<head>
    ...
    <!-- ========== Page Title ========== -->
    <title>Register: N0 1 :: Bitcoin investment company in the world</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="signin">
                    <!-- module logo begin -->
                    <p class="uk-text-small uk-margin-remove-top uk-margin-medium-bottom py-3" style="font-weight:bold; font-size:2em">EXQUISITS</p>
                    <p class="uk-text-lead uk-margin-top uk-margin-remove-bottom">Signup Here</p>

                    <!-- login form begin -->
                    <form class="uk-grid uk-form" method="post" action="php/view/signup.php">
                        ...
                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                            ...
                            <input class="uk-input uk-border-rounded" id="username" value="" name="fullname" type="text" placeholder="Fullname">
                        </div>
                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                            <span class="uk-form-icon uk-form-icon-flip fas fa-user fa-sm"></span>
                        ...
                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                            ...
                            <small style="font-size: 8px;">Minimum 8 characters required (Atleast one uppercase,
                                lowercase and number)</small>
                        </div>
                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                            <span class="uk-form-icon uk-form-icon-flip fas fa-lock fa-sm"></span>
                            <input class="uk-input uk-border-rounded" id="password" value="" name="cpassword" type="password" placeholder="Confirm Password">
                            <span></span>
                        </div>
                    ...
                    <!-- login form end -->
                    <p class="uk-heading-line uk-text-center"><span>Already have an account? <a href="signin.php"> Sign in here</a></span></p>
